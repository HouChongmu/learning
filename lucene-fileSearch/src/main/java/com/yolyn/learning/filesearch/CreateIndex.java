package com.yolyn.learning.filesearch;
...
public class CreateIndex {
	...
	public static List<FileModel> extractFile() throws Exception {
		...
		File fileDir = new File("/Users/yolyn/Desktop/work/demo_workspace/learning/lucene-fileSearch/src/main/resources/files");
		if (!fileDir.exists()) {
